...
def read_csv_part(filepath: str, start_row: int, 
    ...
    read_csv_part(function)
        Input:
            ...
            in the computer.
            - start_row: Row where the process/thread is going to
            start reading the file.
            - chunk_size: Amount of rows that process/thread is
            gonna read.
...
def ReadInputCSV_processes(filepath: str, n_jobs: int = 1, 
                 solutions_id_colum = 0) -> list[list[int]]:
    """
    ...
    Input:
        ...
        solution. Taking advantage of processes we can read rows with
        parallelism.
    """
    # Exception handling: This allows the program to handle common
    # errors in this task.
...
def ReadInputCSV_threads(filepath: str, n_workers: int = 1, 
                 solutions_id_colum = 0) -> list[list[int]]:
    """
    ReadInputCSV(function)
    Input:
            - filepath: Path that allocates the file
            in the computer.
            - n_jobs: number of threads that are gonna read
            equals portions of the input file. if you use -1 the function
            use all core of your computer.
        Output:
            - genes: List of genes names. 
        ...
        Every cell allocates the cluster of their respective gene in the
        solution. Taking advantage of threads we can read rows using
        concurrence.
    """
    # Exception handling: This allows the program to handle common
    # errors in this task.
