"""
he_clustering: This module provides utilities for hierarchical clustering using a
...
2. he_clustering                   – High-level interface for fixed-k clustering, visualization, and export.
...
5. _build_dendrogram_figure        – Construct a single-panel interactive dendrogram figure.
