if __name__ == "__main__":
    ...
    Ac.plot_html_heatmap(Dist_m,  directory + "/Results/File_1/Dist_matrix.html",
                        x_label="Solution",
                        y_label="Solution",
    ...
    ###### Estudio final.
    start_time = time.time()
    CS.parallel_analysis(SC_matrix[0:5], directory + "/Results/File_1_Global", min_Jaccard_Value=0.10, convert_ids=True)
    end_time = time.time()
